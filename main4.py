...
def create_wind_field(course: Course, 
    ...
    Gusts are elongated in the y-direction (upwind/downwind)
    """
    ...
    for _ in range(n_gusts):
        ...
        # Create elongated gust pattern
        x_distance = (X - center_x)**2 / (300**2)  # Narrow in x-direction (200m characteristic size)
        y_distance = (Y - center_y)**2 / (500**2)  # Elongated in y-direction (800m characteristic size)
